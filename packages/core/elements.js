...
export function resolveEmbeddableWorldTransform(instance, p){
...
export function embeddableLocalToWorld(localPt, instance, p){
...
export function embeddableLocalDirToWorld(localDir, instance, p){
...
export function registerSimpleEmbeddable({ id, paramsKey, variants, defaultVariant }){
